C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -NoLogo -NonInteractive -File C:\devops\bin\testsite.ps1 > C:\devops\var\log\testsite.log
